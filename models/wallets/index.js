...
const { walletPattern, walletTotalPattern } = require("../patterns");
...
const joiEditWalletTotalSchema = Joi.object({
  total: Joi.string().pattern(walletTotalPattern).required(),
});
